                                            ...
                                            <tr>
                                                <td>
                                                    <td align="center" style="padding: 15px;">
                                                        <img src="{{ asset('/images/ticket.png') }}" alt="congratz" height="120">
                                                        <h2 style="padding-top: 15px;">Schedule Ticket Has Been Closed</h2>
                                                        <h2 style="padding-bottom: 0;">Schedule No: {{ $schedule->schedule_no }}</h2>
                                                        <p style="text-align:center;">Click the link below to review.</p>
                                                        <a class="button" href='{{ env("APP_URL_WEB") . "/scheduling/detail/".encrypt($schedule->nID) }}' target="_blank">REVIEW</a>
                                                    </td>
                                                </td>
                                            </tr>
                                        </tr>
